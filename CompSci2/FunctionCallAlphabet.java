...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		i(6);    // pass it any integer and it will display a word beginning with I 
		...
		n( "Nap" );    // displays the word you pass it beginning with "N"
		...
		t( "Tardis" );    // displays the word you pass it beginning with "T"
		System.out.print(u( ));    // returns the word to be displayed
		v( 1);    // tell it how many times to display the word (1)
		w(12 );    // pass it any integer and it will display a word beginning with W 
