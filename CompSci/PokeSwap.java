...
public class PokeSwap
{
	public static void main(String[] args)
	{
		...
		String[] pokeParty = { "CHARMELEON", "GYARADOS",  "GEODUDE", "PIKACHU", "BUTTERFREE", "MANKEY" };
		String enemy = "STARMIE", p = "MAGICKARP";
		...
		if ( choice == 1 )
		{
			System.out.println( pokeParty[0] + " used EMBER!  It's not very effective." );
