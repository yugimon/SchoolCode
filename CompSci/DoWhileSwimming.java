...
//1.yes
//2.GALLANT swims for 0 min and GOOFUS swims form 1 min.
//3.GALLANT checks the water first
//4.GOOFUS dives right in
//5.a while loop cheacks the requirement first, a do while checks the requirement after runing the program the first time.
//6. while = pre-test loop, do while = post-test loop