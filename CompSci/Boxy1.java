...
public class Boxy1 extends Canvas
{
	public void paint( Graphics window )
	{
		...
		window.fillRect(400,222,100,100);
		
		window.setColor(Color.WHITE);
		window.fillRect(410,232,80,80);
		
		window.setColor(Color.GREEN);
		window.fillRect(1,1,100,100);
		
		window.setColor(Color.WHITE);
		window.fillRect(11,11,80,80);
		
		window.setColor(Color.MAGENTA);
		window.fillRect(645,400,100,100);
		
		window.setColor(Color.WHITE);
		window.fillRect(655,410,80,80);
	}
