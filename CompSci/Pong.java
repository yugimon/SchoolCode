...
public class Pong extends Canvas
{
	...
	public Pong()
	{
		...
		delta = new Point(-5,5);
		paddle1 = new Rectangle(50,50,20,200);
		paddle2 = new Rectangle(920,450,20,200);
	...
	public void paint( Graphics g )
	{
		...
		g2.setFont(new Font("Calibri", Font.BOLD+Font.ITALIC, 100));
        g2.drawString(""+sp1, 125, 100);
        if (sp1 == 12)
        {
        	g2.setFont(new Font("Calibri", Font.BOLD+Font.ITALIC, 50));
